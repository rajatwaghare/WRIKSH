    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50">
      <main className="flex flex-1 w-full max-w-3xl flex-col justify-between py-32 px-16 sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 sm:items-start sm:text-left">
          <h1 className="text-3xl leading-10 tracking-tight text-black">Beauty awaknes the soul to act.</h1>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <a className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-gray-200 px-5 transition-colors md:w-[158px]" href="https://www.instagram.com/wriksh_beauty/" target="_blank" rel="noopener noreferrer">
            <RiInstagramLine />
            Instagram
          </a>
        </div>
