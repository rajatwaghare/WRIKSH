...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center h-full bg-zinc-50">
      <main className="flex flex-1 gap-10 md:gap-24 w-full max-w-3xl flex-col justify-between py-32 px-4 md:px-16 sm:items-start">
        ...
        <div
          className="fade-in flex flex-col gap-6 sm:items-start sm:text-left"
        ...
        <div
          className="fade-in flex  gap-4 text-base font-medium sm:flex-row"
        ...
        <div
          className="fade-in flex flex-col gap-4 text-base font-medium sm:flex-row mt-20"
